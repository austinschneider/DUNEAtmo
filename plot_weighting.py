...
for i, gen in enumerate(generators):
    ...
    #print_stats("final_state", p, zenith)
    plot_weight("final_state", p)
    ...
    if np.any(nonzero):
        ...
        print_stats("physical_pos", pos_prob, zenith[nonzero])
        plot_weight("physical_pos", pos_prob, nonzero)
        print_stats("physical_int", int_prob, zenith[nonzero])
        plot_weight("physical_int", int_prob, nonzero)
