...
def get_particle_intersections(geo, parent, particles):
    ...
    for j, particle in enumerate(particles):
        ...
        last_inside = d0 >= 0 and d1 < 0
        if last_inside:
            secondaries_inside.append(particle)
    ...
    return entry_ret, exit_ret, track_length, deposited_energy, secondaries_inside
...
def compute_sim_info(geos, parent, particles):
    ...
    for geo in geos:
        ...
        entry_info, exit_info, track_length, energy_in_detector, the_secondaries = get_particle_intersections(geo, parent, particles)
        secondaries_inside.extend(the_secondaries)
    ...
    return morphology, deposited_energy, detector_track_length, start_info, end_info, path_pairs, secondaries_inside
