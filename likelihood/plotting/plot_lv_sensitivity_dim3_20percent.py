...
outdir = "./plots/lv_dim3_20percent/"

fnames = glob.glob(
    "/n/holyscratch01/arguelles_delgado_lab/Lab/DUNEAnalysis/store/scans/lv/dim3_20percent/*.json"
)
...
ax.legend()
#fig.tight_layout()
fig.savefig(outdir + "lv_dim" + ("%d" % dim) + "_20percent_sensitivity.pdf")
fig.savefig(outdir + "lv_dim" + ("%d" % dim) + "_20percent_sensitivity.png", dpi=200)
