...
default_flux_path = '/n/holystore01/LABS/arguelles_delgado_lab/Lab/DUNEAnalysis/store/LV_fluxes/'
...
import glob
fnames = glob.glob("/n/holystore01/LABS/arguelles_delgado_lab/Lab/DUNEAnalysis/store/LV_fluxes/lv/*.h5")
parameter_points = [oscillator.fname_to_params(fname)[2] for fname in fnames]
