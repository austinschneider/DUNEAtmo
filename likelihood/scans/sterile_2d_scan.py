...
output = "sterile_scan_2d.json"

def sterile_2d_scan(asimov_params=default_asimov_params, dm2_grid=dm2_grid, th14=th14, th24_grid=th24_grid, th34=th34, cp=cp, output=output):
