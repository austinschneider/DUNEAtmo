...
the_store.add_prop('binned_asimov_data', ['asimov_data', 'mc_binning'], binned_asimov_data)
...
print(asimov_likelihood(asimov_params, asimov_params) - asimov_likelihood(physical_params, asimov_params))
