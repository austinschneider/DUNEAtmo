...
outdir = './plots/conv_dim_3_re_p-22/'

units = nsq.Const()
conv = nsq.nuSQUIDSAtm("./likelihood/fluxes/lv/H3a_SIBYLL23C_3_z_z_z_z.h5")
#conv_sterile = nsq.nuSQUIDSAtm("./fluxes/conv_sin22th_0p1.h5")
conv_sterile = nsq.nuSQUIDSAtm("./likelihood/fluxes/lv/H3a_SIBYLL23C_3_z_z_p-22.00000000_z.h5")
